          ...
          >
            ...
            <div className="relative overflow-hidden glass-panel rounded-2xl p-8 shadow-sm">
              ...
              <div className="flex flex-col gap-2 max-w-2xl text-left">
                <h2 className="text-xl font-black text-slate-900 tracking-tight">Regional Connectors Hub</h2>
                <p className="text-sm font-medium text-slate-500 leading-relaxed">
                  Bypassing local ERP lock-in. Track the aggregate data ingestion rate of Tally Prime and SAP connectors across the branch without DMS overhead.
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
              <div className="glass-panel p-6 rounded-2xl space-y-4">
                ...
                <h3 className="text-sm font-black text-slate-900 tracking-tight">Active Ingestion</h3>
                <p className="text-xs text-slate-505 font-semibold">
                  88% of East branch distributors (81 of 92 accounts) successfully pushing ledger data daily.
                </p>
              </div>
              ...
              <div className="glass-panel p-6 rounded-2xl space-y-4">
                ...
                <h3 className="text-sm font-black text-slate-900 tracking-tight">Sell-Through Rate</h3>
                <p className="text-xs text-slate-505 font-semibold">
                  East branch achieved 82.4% sell-through compliance score MTD. Safe closing inventory levels.
                </p>
              </div>
              ...
              <div className="glass-panel p-6 rounded-2xl space-y-4">
                ...
                <h3 className="text-sm font-black text-slate-900 tracking-tight">AI Out-of-Stock warnings</h3>
                <p className="text-xs text-slate-505 font-semibold">
                  4 distributors in West Bengal flagged with stockouts on core Classic Trunk lines within 7 days.
                </p>
              </div>
            </div>
          </motion.div>
